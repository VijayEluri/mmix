...
public class HenDaoLiMa extends HuaRongDao {

	@Override
	public void init() {
		blockList.add(new Block(SINGLE, new Point[] { Point.getPoint(4, 2) },
				"Pawn 1"));
		blockList.add(new Block(SINGLE, new Point[] { Point.getPoint(4, 3) },
				"Pawn 2"));
