...
public class RelativeSurviveResult {
	/** from the Breath/eye block owner's point of view.<br/> */
	 ...
	 * 
	 **/
	Boolean independent;// 三值逻辑,null表示未知.

	RelativeResult xianShou = new RelativeResult();// 先手的结果。
	RelativeResult houShou = new RelativeResult();// 后手的结果。
