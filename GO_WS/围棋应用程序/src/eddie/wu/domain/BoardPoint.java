...
public class BoardPoint implements Cloneable, Serializable {
	 ...
	 */
	private int prohibitStep = 0;
	private int prohibitColor = 0;
	 ...
	 */
	public void setProhibitStep(int prohibitStep, int color) {
		this.prohibitStep = prohibitStep;
		this.prohibitColor = color;
	}

	public void clearProhibitStep() {
		if (this.prohibitStep == 0 || this.prohibitColor == 0)
			throw new RuntimeException(
					"this.prohibitStep==0||this.prohibitColor==0");
		this.prohibitStep = 0;
		this.prohibitColor = 0;
	}
...
//	}
	...
	public int getProhibitColor() {
		return prohibitColor;
	}
}