...
public class NeighborState {
	...
	private boolean isRemoveCapturing;
	/**
...
//	private boolean increaseBreath = true;
	private boolean increaseBreath = false;
...
//			if(log.isEnabledFor(Level.WARN)) log.warn("friend =" + friend + ";friendBlocks"
//					+ friendBlocks);
			friend = friendBlocks;
		}
		return friend;
	...
	public String toString() {
		return "NeighborState [" + "original=" + original + ", friendColor="
				...
				+ ", capturing=" + eating + ", valid=" + valid + ", gift="
				+ gifting + ", originalBlankBlockDivided="
				+ originalBlankBlockDivided + ", originalBlankBlockDisappear="
	...
	public boolean isIncreaseBreath() {
		return increaseBreath;
	}

	public void setIncreaseBreath(boolean increaseBreath) {
		this.increaseBreath = increaseBreath;
	}

	public boolean isRemoveCapturing() {
		return isRemoveCapturing;
	}

	public void setRemoveCapturing(boolean isRemoveCapturing) {
		this.isRemoveCapturing = isRemoveCapturing;
	}
