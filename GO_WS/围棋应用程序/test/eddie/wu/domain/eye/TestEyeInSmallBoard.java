...
public class TestEyeInSmallBoard extends TestCase {
	...
	public void testThree() {
		...
		Assert.assertTrue(analysis.isAlreadyLive_dynamic(Point.getPoint(4, 2, 2)));
		Assert.assertTrue(analysis.isAlreadyLive_dynamic(Point.getPoint(4, 3, 3)));
	}
	...
	public void testNew() {
		...
		analysis.printState();
		Assert.assertTrue(analysis.getBlock(Point.getPoint(4, 2, 2))
				.isAlreadyLive_Static());
		Assert.assertTrue(analysis.getBlock(Point.getPoint(4, 3, 3))
				.isAlreadyLive_Static());
	...
	public void testNew2() {
		...
		Assert.assertTrue(analysis.getBlock(Point.getPoint(4, 2, 2))
				.isAlreadyLive_Static());
		Assert.assertFalse(analysis.getBlock(Point.getPoint(4, 1, 1))
				.isAlreadyLive_Static());
	...
	public void testNew21() {
		...
		GoBoard analysis = new GoBoard(state);
		analysis.printState();
		Assert.assertFalse(analysis.getBlock(Point.getPoint(4, 2, 2))
				.isAlreadyLive_Static());
		Assert.assertFalse(analysis.getBlock(Point.getPoint(4, 1, 1))
				.isAlreadyLive_Static());
	...
	public void testNew22() {
		...
		GoBoard analysis = new GoBoard(state);
		analysis.printState();		
		Assert.assertFalse(analysis.getBlock(Point.getPoint(4, 3, 3))
				.isAlreadyLive_Static());
	}
}
