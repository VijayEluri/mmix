...
public class DsNode { // 定式节点。
	...
	/**
	 * 先后手；-1为后手，1为先手；比较时先手大于后手； 有时先后手比较难说清楚，用0表示。
	 */
	public byte xianhoushou;
	/**
	 * 该节点后继变化所在的文件数字， 如果是定式变招，前面为“dingshibianzhao”
	...
	public byte xingshi1;// 征子成立时的形势判断；
	public byte xingshi2;// 征子不成立时的形势判断；

	/**
	 * 遍历标志（走该步的计数） 相对于该步颜色而言；<br/>
	 * 100以上特殊对待，与征子有关； 征子有关不用有利与否的概念，只看征子能否成立。
	 */
	public byte blbz;
