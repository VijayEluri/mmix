...
public class SiHuoZhiZuo
  ...
  public void cgcl() { //chang gui chu li  qi zi  de qi
    ...
    int[] v = {
        0, 0, 0, 0, 0}; //四个邻子的坐标
    int[] k = {
        0, 0, 0, 0, 0}; //array for block index.四邻子的块索引
  ...
  public boolean action(Event e, Object what) {
    ...
    if (e.target == store) { //System.out.println("come into method store!");
      if (bhs == 0) {
        //System.out.println("lins="+shoushu);
