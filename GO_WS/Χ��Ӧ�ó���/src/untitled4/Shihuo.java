...
public class Shihuo extends Applet {
   ...
   Button conglai=new Button("ÖØÀ´");
   Button yanshi=new Button("ÑÝÊ¾");
...
//paint the star point.
//come into the end of method paint
jshuo[2][1]="²»ÊÇÏÈÊÖ£¬¶Ô°×ÍâÎ§Ã»ÓÐÍþÐ²¡£";
//come into method jhcl.jiaohu chu li
//k3=0
//come into method paint
// paint the ver and hor line.
...
//paint the star point.
//come into the end of method paint
jshuo[3][3]="´ò½Ù²»ÊÇÕý½â£¬µ«ÊÇÊµÕ½»òÐí¿ÉÒÔÓÃ£¬ÓÚÈ«¾Ö½Ù²ÄÓÐ¹Ø¡£";
//come into method jhcl.jiaohu chu li
//ti zi 1 xing
//k3=0
//come into method paint
         ...
         if(a==ktm&&b==ktn){// decide is it the prohibtted point?
	       ...
	       if(gotemp==null){
                 ...
                 // fzhengjie=true;
                  cgcl();
                  gotemp=work;
                  jieshuo.setText("ÔÙÏëÏë£¬ÓÐÃ»ÓÐ¸üºÃµÄ½â·¨");
        ...
        for(j=1;j<=p;j++){
           ...
           if(temp==null){
              if(old!=null){
                 ...
                 System.out.println("a="+temp.zba);
                 System.out.println("b="+temp.zbb);
                 ...
                 System.out.println("cha ru gen jie dian");
