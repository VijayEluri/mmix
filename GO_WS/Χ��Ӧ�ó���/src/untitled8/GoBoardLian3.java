 ...
 * @version 1.0
 */
//基本上是GoBoardLian1的代码，主要的改动是将块号变成
//short型，增加能够容纳的块数。
public class GoBoardLian3 {
  ...
  public byte[][][] zb = new byte[21][21][6];
  ...
  public GoBoardLian3() {
    System.out.println("方法GoBoardLian1()");
    byte i, j;
