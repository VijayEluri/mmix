...
public class BoardApplet extends Applet {
	...
	public void init() {
		...
		for (i = 1; i <= 16; i++) { // 初始化棋子
			...
			wb = qishib[i];
			zb[wa][wb] = i;
			qizi[i] = new Qizi(i, zhl[i], wa, wb, HONGFANG);
	 ...
	 * 
	 * int yd1, yd2; yd2 = (i - 1) * 2 * HANGJU + JIANXI - BANJING; yd1 = (j -
	 * 1) * 2 * LIEKUAN + JIANXI - BANJING; yd2 += BANJING * 7 / 8;
	 * //g.setColor(Color.red ) ; if(shizi[i][j]==0){ return ; } if (shizi[i][j]
	 * == 1) {
	 * 
	 * g.drawLine(yd1 + BANJING / 8, yd2, yd1 + 7 * BANJING / 8, yd2); //画横线
	 * g.drawLine(yd1 + BANJING * 9 / 8 + 1, yd2, yd1 + 15 * BANJING / 8 + 1,
	 * yd2); //画横线 g.drawLine(yd1 + BANJING / 8, yd2 + BANJING / 4 + 1, yd1 + 7
	 * * BANJING / 8, yd2 + BANJING / 4 + 1); g.drawLine(yd1 + BANJING * 9 / 8 +
	 * 1, yd2 + BANJING / 4 + 1, yd1 + 15 * BANJING / 8 + 1, yd2 + BANJING / 4 +
	 * 1); //画横线 g.drawLine(yd1 + 7 * BANJING / 8, yd2 - BANJING * 3 / 4, yd1 +
	 * 7 * BANJING / 8, yd2); //画直线 g.drawLine(yd1 + 7 * BANJING / 8, yd2 +
	 * BANJING / 4 + 1, yd1 + 7 * BANJING / 8, yd2 + BANJING + 1);
	 * g.drawLine(yd1 + 9 * BANJING / 8 + 1, yd2 - BANJING * 3 / 4, yd1 + 9 *
	 * BANJING / 8 + 1, yd2); //画直线 g.drawLine(yd1 + 9 * BANJING / 8 + 1, yd2 +
	 * BANJING / 4 + 1, yd1 + 9 * BANJING / 8 + 1, yd2 + BANJING + 1);
	 * 
	 * } else if (shizi[i][j] == 2) { //左边抹去、 //yd2 = (i - 1) * 2 * HANGJU +
	 * JIANXI - BANJING; //yd1 = (j - 1) * 2 * LIEKUAN + JIANXI - BANJING;
	 * g.drawLine(yd1 + BANJING * 9 / 8 + 1, yd2, 1 + yd1 + 15 * BANJING / 8,
	 * yd2); //画横线 g.drawLine(yd1 + BANJING * 9 / 8 + 1, yd2 + BANJING / 4 + 1,
	 * yd1 + 15 * BANJING / 8 + 1, yd2 + BANJING / 4 + 1); //画横线 g.drawLine(yd1
	 * + 9 * BANJING / 8 + 1, yd2 - BANJING * 3 / 4, yd1 + 9 * BANJING / 8 + 1,
	 * yd2); //画直线 g.drawLine(yd1 + 9 * BANJING / 8 + 1, yd2 + BANJING / 4 + 1,
	 * yd1 + 9 * BANJING / 8 + 1, yd2 + BANJING + 1);
	 * 
	 * } else if (shizi[i][j] == 3) {
	 * 
	 * g.drawLine(yd1 + BANJING / 8, yd2, yd1 + 7 * BANJING / 8, yd2); //画横线
	 * g.drawLine(yd1 + BANJING / 8, yd2 + BANJING / 4 + 1, yd1 + 7 * BANJING /
	 * 8, yd2 + BANJING / 4 + 1); g.drawLine(yd1 + 7 * BANJING / 8, yd2 -
	 * BANJING * 3 / 4, yd1 + 7 * BANJING / 8, yd2); //画直线 g.drawLine(yd1 + 7 *
	 * BANJING / 8, yd2 + BANJING / 4 + 1, yd1 + 7 * BANJING / 8, yd2 + BANJING
	 * + 1); }
	 * 
	 * }
	 */
