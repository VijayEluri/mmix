...
public class Board4
  ...
  public Board4(Daojishi dj1, Daojishi dj2) {
  ...
  public void init() {
    ...
    for (i = 1; i <= 7; i++) { //hong fang zai qian.
      ...
      yuansu[i] = new ImageIcon(tupianxiangqi.Board4.class.getResource(imagename)).
        getImage();
      ...
      yuansu[i +
        7] = new ImageIcon(tupianxiangqi.Board4.class.getResource(imagename)).
        getImage();
    ...
    yuansu[0] = new ImageIcon(tupianxiangqi.Board4.class.getResource("Board.jpg")).
      getImage();

    System.out.println("yuansu[i]=" + yuansu[i]);
    System.out.println("yuansu[i]=" + yuansu[i].getSource());

    yuansu[15] = new ImageIcon(tupianxiangqi.Board4.class.getResource(
