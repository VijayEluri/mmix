...
public class TestSurviveCalculate extends TestCase {
	...
	GoBoard survive2 = new GoBoard(Constant.BOARD_SIZE);

	public void test() {
		byte[][] state = StateAnalysis.LoadState(root + name1);
		BoardColorState bcs = new BoardColorState(state, Constant.BLACK);
	 ...
	 * 限制，比如优先级较低的就不在考虑。） 4. 5位夹后，四个候选点，有两个点自紧一气，还剩二气。另两个点为扑入。 5.
	 * 为了快速计算，必须将一些计算结果储存起来，比如刀把五。
	 */
	public void test6() {
	 ...
	 * WBB456<br/>
	 * 1. 前两步的候选点相同。<br/>
	 * 2. 第四步扑入成劫（缓一气劫）。当然对方提后才真正开始劫争。 <br/>
	 */
	public void test7() {
