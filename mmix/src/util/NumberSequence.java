...
/**
 * <p>
 * NumberSequence.java to get all kinds of number sequence.
 * </p>
 */
public class NumberSequence {
	private static long[] fabo = { 0L, 1L, 1L, 2L, 3L, 5L, 8L, 13L, 21L, 34L,
			55L, 89L, 144L, 233L, 377L, 610L, 987L, 1597L, 2584L, 4181L, 6765L,
	...
	public static long[] getFabonacii() {
		return fabo;
	}

	public static Long[] getFabonacii2() {
		...
		// Long[] f = (Long[])list.toArray(f);
		Long[] f = new Long[list.size()];
		list.toArray(f);
		return f;
	}
