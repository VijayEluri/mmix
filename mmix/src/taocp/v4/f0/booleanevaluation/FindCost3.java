 ...
 * 
 * cf = 0; functions = 8 -- 4 
 * cf = 1; functions = 30 -- 15 
 * cf = 2; functions = 114 -- 57 
 * cf = 3; functions = 80 -- 40 
 * cf = 4; functions = 24 -- 12
 * 
 * 
 * @author Eddie Wu
 * @version 1.0
...
public class FindCost3 {
	...
	private boolean judgef(int g, int h) {
		if (U[f] == -1) {
			...
			if (u == U[f]) {
				...
				// System.out.println("r = " + r + " cost decrease one for f=" +
				// f
				// + "; u=" + u);
	...
	public static void main(String[] args) {
		...
		new FindCost3().findCost();
		// new FindCost().init();
		long end = System.currentTimeMillis();
		System.out.println("mini-seconds = " + (end - start));
	}
