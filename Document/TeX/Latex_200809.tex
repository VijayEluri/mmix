...
I am an experienced Software Engineer with outstanding knowledge of J2EE platform, Oracle database, and Linux. 

{bf Java} I am not only good at Java programming, but also familiar with C and C++. 
I not only have ever read the source code of Struts, Spring and Hibernate etc., but also have ever read the source code of Linux kernel. The kind of background provide me a more practical and pragmatic attitude about technical.
